...
module('Acceptance | guid-node/forks', hooks => {
    ...
    test('logged out, no forks', async function(assert) {
        ...
        await vizzlyScreenshot('forks-logged-out-no-forks', {
            feature: 'projects',
            page: 'forks',
    ...
    test('logged in admin, 12 forks', async function(assert) {
        ...
        await vizzlyScreenshot('forks-admin-paginated-list', {
            feature: 'projects',
            page: 'forks',
            scenario: 'paginated-forks-list',
        });
    ...
    test('logged in admin, new fork', async function(assert) {
        ...
        await vizzlyScreenshot('forks-create-fork-confirmation-modal', {
            feature: 'projects',
            page: 'forks',
